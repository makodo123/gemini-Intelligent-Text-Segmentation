            ...
            <div className="px-6 py-4 border-b border-slate-100 bg-slate-50 flex justify-between items-center sticky top-0 z-10 flex-wrap gap-2">
              ...
              <div className="flex items-center gap-3">
                <button 
                  ...
                  className="text-xs sm:text-sm text-indigo-700 hover:text-indigo-900 font-medium px-3 py-1.5 bg-indigo-100 hover:bg-indigo-200 rounded-lg transition-colors flex items-center gap-1"
                  title="根據標點符號自動分割長句"
                >
